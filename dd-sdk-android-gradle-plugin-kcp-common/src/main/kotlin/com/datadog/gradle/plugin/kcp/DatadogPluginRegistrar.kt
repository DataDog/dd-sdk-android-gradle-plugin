...
abstract class DatadogPluginRegistrar(
            ...
            project.extensionArea.getExtensionPoint(IrGenerationExtension.extensionPointName)
                .registerExtension(
                    getCompatibleComposeNavHostExtension(
                        ...
                        instrumentationMode = internalCompilerConfiguration
                    ),
                    LoadingOrder.FIRST,
                    project
                )
    ...
    /**
     * Provides ComposeNavHostExtension implementation.
     * @param messageCollector message collector to report errors
     * @param instrumentationMode instrumentation mode
     */
    @OptIn(FirIncompatiblePluginAPI::class)
    abstract fun getCompatibleComposeNavHostExtension(
        messageCollector: MessageCollector,
        instrumentationMode: InstrumentationMode
    ): IrGenerationExtension

    /**
     * Provides ComposeTagExtension implementation.
     * @param messageCollector message collector to report errors
     * @param instrumentationMode instrumentation mode
     */
    @OptIn(FirIncompatiblePluginAPI::class)
    abstract fun getCompatibleComposeTagExtension(
        messageCollector: MessageCollector,
        instrumentationMode: InstrumentationMode
    ): IrGenerationExtension

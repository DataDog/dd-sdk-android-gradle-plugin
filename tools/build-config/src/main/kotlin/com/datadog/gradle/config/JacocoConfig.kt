...
internal fun Project.jacocoConfig() {
    ...
    listOf(jacocoTestReport, jacocoTestCoverageVerification).forEach {
    ...
    jacocoTestReport.configure { dependsOn("test") }
    jacocoTestCoverageVerification.configure { dependsOn(jacocoTestReport) }

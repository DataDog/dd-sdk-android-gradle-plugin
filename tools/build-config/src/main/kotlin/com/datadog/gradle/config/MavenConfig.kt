...
object MavenConfig {
    ...
    val VERSION = Version(1, 28, 0, Version.Type.Snapshot)
...
internal fun Project.publishingConfig(projectDescription: String) {
    ...
    signingExtension.apply {
        ...
        afterEvaluate {
            ...
            if (!hasGradlePluginPublishPlugin) {
    ...
    afterEvaluate {
        ...
        publishingExtension.apply {
            val publicationName = if (hasGradlePluginPublishPlugin) {
...
private val Project.hasGradlePluginPublishPlugin: Boolean
    get() {
        return pluginManager.hasPlugin("com.gradle.plugin-publish")
    }
